...
describe('BUREAUCRAT', () => {
    it('works normally', (d) => {
        const [game, [player, q], done] = makeTestGame({
            decks: [['bureaucrat', 'copper', 'copper', 'copper', 'copper'], ['estate', 'duchy', 'copper', 'copper', 'copper']],
            d,
            players: 2
        });
        ...
        player.onBuyPhaseStart(() => {
            ...
            expect(q.hand).to.have.members(['duchy', 'copper', 'copper', 'copper']);
            done();
        });
        game.start();
    });
    it('can be throne roomed', (d) => {
        const [game, [player, q], done] = makeTestGame({
            decks: [['bureaucrat', 'throne room', 'copper', 'copper', 'copper'], ['estate', 'duchy', 'province', 'copper', 'copper']],
            d,
            players: 2
        });
        ...
        player.onBuyPhaseStart(() => {
            ...
            expect(q.hand).to.have.members(['province', 'copper', 'copper']);
            done();
        });
        game.start();
    })
